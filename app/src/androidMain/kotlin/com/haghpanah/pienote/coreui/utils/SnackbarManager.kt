package com.haghpanah.pienote.coreui.utils
...
import com.haghpanah.pienote.R
import com.haghpanah.pienote.coreui.utlis.SnackBarManager
    ...
    suspend fun sendError(
        ...
        val snackbarData = SnackbarData(
            ...
            action = action?.let {
                SnackbarAction(
                    action = action,
                    label = context.getString(Res.string.label_try_again)
                )
            }
        )
