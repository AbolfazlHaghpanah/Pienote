...
import com.haghpanah.pienote.utils.MenuItemOption.Bold
import com.haghpanah.pienote.utils.MenuItemOption.Code
import com.haghpanah.pienote.utils.MenuItemOption.Copy
import com.haghpanah.pienote.utils.MenuItemOption.Cut
import com.haghpanah.pienote.utils.MenuItemOption.Paste
...
import pienote.texteditor.generated.resources.label_bold
import pienote.texteditor.generated.resources.label_code
import pienote.texteditor.generated.resources.label_copy
import pienote.texteditor.generated.resources.label_cut
import pienote.texteditor.generated.resources.label_paste
import pienote.texteditor.generated.resources.label_select_all
import pienote.texteditor.generated.resources.label_underline
...
private class TextActionModeCallback(
    ...
    private fun addMenuItem(menu: Menu, item: MenuItemOption) {
        //TODO find title Resource
        menu.add(0, item.id, item.order, item.titleResource.key)
...
enum class MenuItemOption(val id: Int) {
    ...
    val titleResource: StringResource
        get() = when (this) {
            Bold -> Res.string.label_bold
            Code -> Res.string.label_code
            UnderLine -> Res.string.label_underline
            Copy -> Res.string.label_copy
            Paste -> Res.string.label_paste
            Cut -> Res.string.label_cut
            SelectAll -> Res.string.label_select_all
        }
